...
// maxSubmoduleDepth bounds the walk out of nested submodules. Real repositories
// rarely nest more than two deep; the rest is headroom, and the bound is what keeps a
