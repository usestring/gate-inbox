...
func (v fakeView) Replace(context.Context, string, extension.LaunchRequest, ...extension.ReplaceOptions) (extension.SessionInfo, extension.ReplaceHandle, error) {
	return extension.SessionInfo{}, nil, errors.New("no replacements here")
}
...
func (v fakeView) Archive(context.Context, string) error {
	return errors.New("no archives here")
}
