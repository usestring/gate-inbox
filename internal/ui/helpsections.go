...
func helpSections() []helpSection {
	...
	return []helpSection{
		{title: "list", rows: []helpRow{
			...
			listRow(keymap.TakeOver, "take over adopted panes: restart each as a managed session once idle"),
		...
		{title: "restoring panes at startup", rows: []helpRow{
			bound(keymap.ContextRestore, keymap.Confirm, "restore them"),
			bound(keymap.ContextRestore, keymap.Cancel, "leave them; from the picker, back to the count"),
			bound(keymap.ContextRestore, keymap.More, "choose which ones"),
